...
public class Pokemans {
    static Move waste = new AttackMove("Fire", "Waste", 1, 1, 1);
    static Move Flamethrower = new AttackMove("Fire", "Flamethrower", 25, 100, 35);
    static Move Earthquake = new AttackMove("Ground", "Earthquake", 25, 100, 35);
    static Move Bug_Buzz = new AttackMove("Bug", "Bug Buzz", 25, 90, 30);
    static Move Outrage = new AttackMove("Dragon", "Outrage", 10, 100, 40);
    static Move Ice_Beam = new AttackMove("Ice", "Ice Beam", 15, 100, 30);
    static Move Close_Combat = new AttackMove("Fighting", "Close Combat", 5, 95, 40);
    static Move Hurricane = new AttackMove("Flying", "Hurricane", 10, 70, 42);
    static Move Vine_Whip = new AttackMove("Grass", "Vine Whip", 8, 85, 42);
    static Move Shadow_Ball = new AttackMove("Ghost", "Shadow Ball", 20, 100, 35);
    static Move Thunderbolt = new AttackMove("Electric", "Thunderbolt", 20, 100, 37);
    static Move Hyperbeam = new AttackMove("Normal", "Hyperbeam", 5, 100, 40);
    static Move Gunk_Shot = new AttackMove("Poison","Gunk Shot", 15, 90, 40);
    static Move Psychic = new AttackMove("Psychic", "Psychic",20, 100, 37);
    static Move Stone_Edge = new AttackMove("Rock","Stone Edge", 10, 70, 40);
    static Move Hydropump = new AttackMove("Water", "Hydro Pump",10, 80, 45);
...
//    static Move WillOWisp = new StatusMove("Fire","Willow Wisp", 32, 85, 2);
    ...
    static Move Leaf_Blade = new AttackMove("Grass","Leaf Blade" ,16, 90, 32);
